...
- [UI Guidelines](../docs/ui-guidelines.md) - UI standards, component library, color palette, and accessibility requirements
- [Testing Guidelines](../docs/testing-guidelines.md) - Testing principles, frameworks, file conventions, and best practices
